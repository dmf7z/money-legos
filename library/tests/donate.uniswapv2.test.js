...
describe("Donate Graph With Uniswap V2", function() {
  let contracts;
  let elements;
  ...
  it("Donate Graph", async function() {
    ...
    let id3_1 = graph.addElement(element, 0, 3, [
      {
        index: 1,
        value: "10000",
      },
    ...
    let id4 = graph.connectElements([[id3_1, 0, 0]], element, 1, 3);

    //Create operation and connect them
    element = elements.OP_UNISWAP_V2_WBTC_TO_WETH;
